...
<title>Trivia Challenge One</title>
...
<label>Question : Which fictional city is the home of Batman?</label><br>
...
<button type="submit" class="submit btn btn-info" data-action="/skipvalidatetriviachallengeone">Skip</button>
</div>
</form>
</div>
</body>
